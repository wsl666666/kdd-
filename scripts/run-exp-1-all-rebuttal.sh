...
function run_exp_1 () {
    ...
    do
        # for aggregate_type in  mlp gaussian pprgo ppe;
        # for aggregate_type in  gcn;
        for aggregate_type in  mlpppe;
        do
...
# exp_version=999 # 999 is for gcn only  301 is for all old methods.
exp_version=998 # 999 is for gcn only  301 is for all old methods.
